...
// Keep everything in anonymous function, called on window load.
  ...
  function img_update () {
		...
		if(total%10==0) textToSpeech("Oops! That's not correct. Try again!")
		else if(total%10==1) textToSpeech("Sorry, incorrect answer. Keep trying!")
		else if(total%10==2) textToSpeech("Not quite. Better luck next time!")
		else if(total%10==3) textToSpeech("Oh no! That's incorrect. Keep going!")
		else if(total%10==4) textToSpeech("Incorrect answer. But don't give up!")
		else if(total%10==5) textToSpeech("Not the right one. Keep guessing!")
		else if(total%10==6) textToSpeech("Nope, that's not it. Try another!")
		else if(total%10==7) textToSpeech("Incorrect. But keep on trying!")
		else if(total%10==8) textToSpeech("Incorrect answer. Keep pushing!")
		else textToSpeech("Not quite right. Try again!")
        $("#popupNon").popup("open", { positionTo: "#imageView" });
    } else {
		// Correct validation
		if(total%10==0) textToSpeech("Great job! You got it right!")
		else if(total%10==1) textToSpeech("Excellent! That's the correct answer!")
		else if(total%10==2) textToSpeech("You're on fire! Correct!")
		else if(total%10==3) textToSpeech("Fantastic! You nailed it!")
		else if(total%10==4) textToSpeech("Bravo! You got it!")
		else if(total%10==5) textToSpeech("Well done! Correct answer!")
		else if(total%10==6) textToSpeech("Superb! That's it!")
		else if(total%10==7) textToSpeech("Amazing! You're correct!")
		else if(total%10==8) textToSpeech("Spot on! That's the right answer!")
		else textToSpeech("Perfect! You got it right!")
		...
		if(flag==1)
		{
			...
			if(total==0)
			{
				document.getElementById("points").innerHTML = "0 Points... Try again!";
			}
			else if(total==1)
			{
				document.getElementById("points").innerHTML = "1 Point! Better than nothing!";
			}
			else if(total<=5)
			{
				document.getElementById("points").innerHTML = total+" Points. Not bad!";
			}
			else if(total<=10)
			{
			...
			{
				document.getElementById("points").innerHTML = total+" Points! Awesome!!";
			}
			else
			{
		...
		else
		{
			...
			if(total==0)
			{
				document.getElementById("points").innerHTML = "0 Point... Try again!";
			}
			else if(total==1)
			{
				document.getElementById("points").innerHTML = "1 Point! Better than nothing!";
